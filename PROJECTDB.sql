...
CREATE OR REPLACE TRIGGER ordenes_audit
BEFORE INSERT OR DELETE OR UPDATE ON orden 
FOR EACH ROW
ENABLE
DECLARE
V_USER VARCHAR2(30);
...
IF INSERTING THEN
INSERT INTO ORDENES_AUDIT(NEW_NAME,OLD_NAME,USER_NAME,ENTRY_DATE,OPERATION) VALUES (:NEW.ID_ORDEN,NULL,V_USER,V_DATE,'INSERT');
ELSIF DELETING THEN
INSERT INTO ORDENES_AUDIT(NEW_NAME,OLD_NAME,USER_NAME,ENTRY_DATE,OPERATION) VALUES (NULL,:OLD.ID_ORDEN,V_USER,V_DATE,'DELETE');
ELSIF UPDATING THEN
INSERT INTO ORDENES_AUDIT(NEW_NAME,OLD_NAME,USER_NAME,ENTRY_DATE,OPERATION) VALUES (:NEW.ID_ORDEN,:OLD.ID_ORDEN,V_USER,V_DATE,'UPDATE');
END IF;
END;

CREATE OR REPLACE TRIGGER clientes_audit
...
SELECT USER,TO_CHAR(SYSDATE,'DD/MON/YYYY HH24:MI:SS') INTO V_USER, V_DATE FROM DUAL;
IF INSERTING THEN
INSERT INTO ORDENES_AUDIT(NEW_NAME,OLD_NAME,USER_NAME,ENTRY_DATE,OPERATION) VALUES (:NEW.CODIGO_CLIENTE,NULL,V_USER,V_DATE,'INSERT');
ELSIF DELETING THEN
INSERT INTO ORDENES_AUDIT(NEW_NAME,OLD_NAME,USER_NAME,ENTRY_DATE,OPERATION) VALUES (NULL,:OLD.CODIGO_CLIENTE,V_USER,V_DATE,'DELETE');
ELSIF UPDATING THEN
INSERT INTO ORDENES_AUDIT(NEW_NAME,OLD_NAME,USER_NAME,ENTRY_DATE,OPERATION) VALUES (:NEW.CODIGO_CLIENTE,:OLD.CODIGO_CLIENTE,V_USER,V_DATE,'UPDATE');
END IF;
END;

CREATE OR REPLACE TRIGGER facturas_audit
...
SELECT USER,TO_CHAR(SYSDATE,'DD/MON/YYYY HH24:MI:SS') INTO V_USER, V_DATE FROM DUAL;
IF INSERTING THEN
INSERT INTO ORDENES_AUDIT(NEW_NAME,OLD_NAME,USER_NAME,ENTRY_DATE,OPERATION) VALUES (:NEW.ID_FACTURA,NULL,V_USER,V_DATE,'INSERT');
ELSIF DELETING THEN
INSERT INTO ORDENES_AUDIT(NEW_NAME,OLD_NAME,USER_NAME,ENTRY_DATE,OPERATION) VALUES (NULL,:OLD.ID_FACTURA,V_USER,V_DATE,'DELETE');
ELSIF UPDATING THEN
INSERT INTO ORDENES_AUDIT(NEW_NAME,OLD_NAME,USER_NAME,ENTRY_DATE,OPERATION) VALUES (:NEW.ID_FACTURA,:OLD.ID_FACTURA,V_USER,V_DATE,'UPDATE');
INSERT INTO ORDENES_AUDIT(NEW_NAME,OLD_NAME,USER_NAME,ENTRY_DATE,OPERATION) VALUES (:NEW.FECHA_EMISION,:OLD.FECHA_EMISION,V_USER,V_DATE,'UPDATE');
INSERT INTO ORDENES_AUDIT(NEW_NAME,OLD_NAME,USER_NAME,ENTRY_DATE,OPERATION) VALUES (:NEW.ID_ORDEN,:OLD.ID_ORDEN,V_USER,V_DATE,'UPDATE');
END IF;
END;
...
/*Prueba tipo pago 
declare 
d_tpago varchar2(30) := 'Efectivo';
BEGIN
pkg_gestion.agregar_tipopago(d_tpago);
END;

declare 
d_tpago varchar2(30) := 'Tarjeta Credito';
BEGIN
pkg_gestion.agregar_tipopago(d_tpago);
END;

declare 
d_tpago varchar2(30) := 'Tarjeta Debito';
BEGIN
pkg_gestion.agregar_tipopago(d_tpago);
END;
*/
